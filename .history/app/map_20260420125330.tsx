...
if (Platform.OS !== "web") {
    const mapsImport = require("react-native-maps");
    MapView = mapsImport.default;
    Marker = mapsImport.Marker;
    Polyline = mapsImport.Polyline;
    PROVIDER_GOOGLE = mapsImport.PROVIDER_GOOGLE;
}
                                            ...
                                            <View style={{
                                                ...
                                                {eta && (
                                                    <Text style={{
                                                        ...
                                                        {eta.passed ? 'Γ£ô Passed' : `~${formatETA(eta.durationSeconds)}`}
                                                    </Text>
                                                )}
                                            </View>
                                            <View style={{
                                        ...
                                        {stopETAs.map((eta) => (
                                            <View key={eta.stopId} style={styles.etaRow}>
                                                ...
                                                <Text style={[
                                                    ...
                                                    {eta.passed ? 'Γ£ô' : `~${formatETA(eta.durationSeconds)}`}
                                                </Text>
                                            </View>
                                        ))}
                                    </View>
