// Fallback file - Metro requires this. For web, the .web.tsx file will be used instead.
// For native, this re-exports the .native.tsx version.
export { default } from "./map.native";
import { Platform } from "react-native";

// Platform-aware import resolution
let MapComponent: any;

if (Platform.OS === "web") {
  // Dynamically require web-specific component
  MapComponent = require("./map.web.tsx").default;
} else {
  // Dynamically require native-specific component
  MapComponent = require("./map.native.tsx").default;
}
...
const Polyline =
  Platform.OS !== "web" ? require("react-native-maps").Polyline : null;
