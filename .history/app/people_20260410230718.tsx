...
export default function People() {
  ...
  // Read tab from route params on mount
  useEffect(() => {
    const params = route.params as { tab?: "students" | "parents" } | undefined;
    if (params?.tab) {
              ...
              <View style={styles.paginationContainer}>
                ...
                >
                  <Ionicons
                    name="chevron-back"
                    size={20}
                    color={currentPage === 1 ? "#ccc" : PRIMARY_BLUE}
                  />
                  <Text
                    style={[
                      styles.pageBtnText,
                ...
                >
                  ...
                  <Ionicons
                    ...
                    size={20}
                    color={currentPage === totalPages ? "#ccc" : PRIMARY_BLUE}
                  />
                </TouchableOpacity>
              </View>
            ) : null
