    ...
    const loadCurrentProfile = async () => {
        try {
            ...
            if (userDataStr) {
                ...
                if (userData.profileImage) setImageUri(userData.profileImage);
                if (!address && userData.address) setAddress(userData.address);
            }
        } catch (error) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.user) {
                    ...
                    const updatedImage = (data.user.ProfileImage || data.user.profileImage);
    ...
    return (
        <View style={styles.inputGroup}>
            ...
            <View style={[styles.inputContainer, multiline && styles.textAreaContainer]}>
                <Ionicons name={icon} size={20} color={DEEP_BLUE} style={styles.inputIcon} />
                <TextInput
