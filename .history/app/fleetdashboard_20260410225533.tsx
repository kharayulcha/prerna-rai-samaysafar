...
export default function FleetDashboard() {
  ...
  // ΓöÇΓöÇ Pulse animation for live dot ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
  ...
  // ΓöÇΓöÇ Tick every second for live "X ago" counter ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
  ...
  // Socket.IO ΓÇö instant updates on trip start/end ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
    connectSocket();
    ...
    <View style={[styles.card, isActive && styles.cardActive]}>
      ...
      <View style={styles.cardHeader}>
        <View
          style={[
            styles.busIconBox,
            { backgroundColor: isActive ? "#DBEAFE" : NEUTRAL_LIGHT },
          ]}
        >
  ...
  return (
    ...
    >
      <View
        style={[
          styles.badgeDot,
          { backgroundColor: active ? SUCCESS : NEUTRAL },
        ]}
      />
      <Text
        style={[styles.badgeText, { color: active ? "#166534" : TEXT_MID }]}
      >
        {active ? "ACTIVE" : "IDLE"}
      </Text>
    </View>
