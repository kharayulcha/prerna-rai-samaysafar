        ...
        if (token) {
          ...
          if (decoded) {
            setProfile({
              ...
              routeName: freshUser?.routeName || decoded.routeName || decoded.RouteName || "",
              busNumber: freshUser?.busNumber || decoded.busNumber || decoded.BusNumber || "",
            });
            if (freshUser?.ProfileImage || freshUser?.profileImage) {
              const imageUrl = getImageUrl(freshUser.ProfileImage || freshUser.profileImage);
