                        ...
                        {assignedRouteInfo && (
                            <View style={styles.infoCard}>
                                ...
                                <View style={styles.infoRow}>
                                    ...
                                    <Text style={styles.value}>{assignedRouteInfo.startTime}</Text>
                                </View>
                                <View style={styles.infoRow}>
                                    <Text style={styles.label}>Driver:</Text>
                                    <Text style={styles.value}>{assignedRouteInfo.driver || "N/A"}</Text>
                                </View>
                                <View style={styles.infoRow}>
                                    <Text style={styles.label}>Bus:</Text>
                                    <Text style={styles.value}>{assignedRouteInfo.bus || "N/A"}</Text>
                                </View>
                            </View>
                        )}
                                ...
                                {studentSchedule.map((sch: any, idx: number) => (
                                    <View key={idx} style={styles.scheduleItem}>
                                        <Text style={styles.scheduleTime}>
                                            {formatTimeStr(sch.StartTime)} - {formatTimeStr(sch.EndTime)}
                                        </Text>
                                        <Text style={styles.scheduleDay}>{sch.ScheduleDays || "Daily"}</Text>
                                    </View>
                                ))}
                            </View>
                        )}
                                ...
                                {studentStops.map((stop: any, idx: number) => (
                                    <View key={idx} style={styles.stopItem}>
                                        ...
                                        <View style={styles.stopInfo}>
                                            <Text style={styles.stopName}>{stop.Name || stop.name}</Text>
                    ...
                    <View>
                        {routes.length > 0 ? (
                            ...
                            <View style={styles.emptyContainer}>
                                <Ionicons name="calendar-outline" size={60} color={PRIMARY_BLUE} />
