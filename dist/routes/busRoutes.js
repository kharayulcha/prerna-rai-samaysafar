...
import { createBus, deleteBus, editBus, getBus, getFleetStatus, listBuses } from '../controller/busController.js';
import catchAsync from '../utils/catchAsync.js';
const router = express.Router();
// List and create
router.get('/get-buses', catchAsync(listBuses)); // GET /api/buses
router.get('/get-fleet-status', catchAsync(getFleetStatus)); // GET /api/buses/get-fleet-status
